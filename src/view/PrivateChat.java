...
import controller.ChiffrementMisty1;
...
public class PrivateChat extends javax.swing.JFrame {
    ...
    public PrivateChat(String sender, String receiver, String serverHost, BufferedWriter bw, BufferedReader br) {
            try {
                ...
                tpMessage_pc.setEditorKit(htmlKit);
                tpMessage_pc.setDocument(htmlDoc);
                // generating RSA public and private keys for eveery new user
                KeyPairGenerator generator = KeyPairGenerator.getInstance("RSA");
                generator.initialize(2048);
                KeyPair pair = generator.generateKeyPair();
                privateKey = pair.getPrivate();
                publicKey = pair.getPublic();
                try (FileOutputStream fos = new FileOutputStream(String.format("%s.key",sender))) {
    ...
    public void appendMessage_Left(String msg1, String msg2) {     
      ...
      char[] array = new char[500];
                FileReader input = new FileReader("key/Misty1Key.txt");
      ...
      // Closes the reader
                 input.close();
               PrivateKey please =privateKey ; 
                System.out.println("private key");
                System.out.println(please);
                System.out.println("private key");
                //String privatekey = privateKey ; 
                 String misty1CryptedKey = Arrays.toString(array);
                RSA RSACipher = new RSA();
                 String DecryptedMisty1Key = null ; 
                 StringBuilder sbf = new StringBuilder() ; 
                 sbf.append(array);
                 //byte[] bytes = Base64.getDecoder().decode(test);
            try {
                 DecryptedMisty1Key = RSACipher.decrypt(test,privateKey);
            } catch (Exception ex) {
                Logger.getLogger(PrivateChat.class.getName()).log(Level.SEVERE, null, ex);
            }
            // Decrypted misty1 key ?
                System.out.println("Decrypted misty1 key");
                System.out.println(DecryptedMisty1Key);
                System.out.println("Decrypted misty1 key");
            // Decrypting message with misty1
              ChiffrementMisty1 m1 = new ChiffrementMisty1();
              // char[] encryptedChar =msg2.toCharArray() ; 
               String decrypted = m1.Misty1Decrypt(msg2,DecryptedMisty1Key);
              // Decrypted message
                System.out.println("Decrypted message ");
                System.out.println(decrypted);
                System.out.println("Decrypted message");
            //return decrypted;message
            htmlKit.insertHTML(htmlDoc, htmlDoc.getLength(), "<p style=\"color:black; padding: 3px; margin-top: 4px; margin-right:35px; text-align:left; font:normal 12px Tahoma;\"><span style=\"background-color:#f3f3f3;\"><b>" + msg1 + "</b><span style=\"color:black;\">" + decrypted + "</span></span></p>", 0, 0, null);
    ...
    public void appendMessage_Left(String msg1, String msg2, String color1, String color2) {     
                ...
                // Reads characters
                 ...
                 System.out.println("Data in the file: ");
                 System.out.println(array);
                 String misty1CryptedKey = array.toString();
                input.close(); 
                PrivateKey please =privateKey ; 
                System.out.println("private key");
                System.out.println(please);
                System.out.println("private key");
                // decrypt the misty1 key
                 RSA RSACipher = new RSA();
                 String DecryptedMisty1Key = null ; 
            try {
                 DecryptedMisty1Key = RSACipher.decrypt("                                                                                                                                                            ", privateKey);
            } catch (Exception e) {
            ...
            htmlKit.insertHTML(htmlDoc, htmlDoc.getLength(), "<p style=\"color:" + color1 + "; padding: 3px; margin-top: 4px; margin-right:35px; text-align:left; font:normal 12px Tahoma;\"><span><b>" + msg1 + "</b><span style=\"color:" + color2 + ";\">" + decrypted + "</span></span></p><br/>", 0, 0, null);
        } catch (BadLocationException | IOException ex) {
            Logger.getLogger(PrivateChat.class.getName()).log(Level.SEVERE, null, ex);
        }
        tpMessage_pc.setCaretPosition(tpMessage_pc.getDocument().getLength());
